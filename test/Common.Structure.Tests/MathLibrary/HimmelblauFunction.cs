...
namespace Effanville.Common.Structure.Tests.MathLibrary
{
    ...
    {
        /// <inheritdoc/>
        public VectorFuncEval GlobalMinimum => new VectorFuncEval(new[] { 3.0, 2.0 }, 0.0);

        public VectorFuncEval[] LocalMinima =>
            new[]
            {
                new VectorFuncEval(new[] { 3.0, 2.0 }, 0.0),
                new VectorFuncEval(new[] { -2.805118,3.131312 }, 0.0),
                new VectorFuncEval(new[] { -3.779310,-3.283186 }, 0.0),
                new VectorFuncEval(new[] { 3.584428,-1.848126 }, 0.0),
            };
