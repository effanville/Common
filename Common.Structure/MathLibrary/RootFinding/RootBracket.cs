...
{
    public static class RootBracket
    {
        public sealed class Bracket
        {
            ...
            public Bracket(double lowerBound, double upperBound)
            {
        ...
        /// </summary>
        public static Result<Bracket> FindBracketForRoot(
            double lowerGuess,
            double upperGuess,
            ...
            int maxIterations = 50)
        {
            ...
            for (int j = 0; j < maxIterations; j++)
            {
                if (f1 * f2 < 0)
                {
                    return new Bracket(lowerGuess, upperGuess);
                }
            ...
            return Result.ErrorResult<Bracket>("Exceeded max number of iterations.");
        }
        ...
        /// </summary>
        public static List<Bracket> NarrowBracketForRoot(
            double lowerBound,
            double upperBound,
            Func<double, double> func,
            ...
            int maxDesiredNumberRoots)
        {
            ...
            for (int i = 0; i < numberSubDivisions; i++)
            {
                ...
                if (fc * fp <= 0)
                {
                    brackets.Add(new Bracket(x - dx, x));
