...
namespace Common.Structure.ReportWriting
{
    ...
    public static class ChartWriting
    {
        ...
        /// </summary>
        public static void WriteLineChart(StringBuilder sb, string name, string title, IReadOnlyList<string> labels, IReadOnlyList<string> xValues, IReadOnlyList<IReadOnlyList<string>> yValues, bool xAxisIsTime)
        {
        ...
        /// </summary>
        public static void WriteBarChart(StringBuilder sb, string name, string title, string dataLabel, IReadOnlyList<string> labels, IReadOnlyList<string> yValues)
        {
            if (labels.Count != yValues.Count)
            {
                return;
        ...
        /// Writes a bar chart into the string builder.
        /// </summary>
        public static void WritePieChart(StringBuilder sb, string name, string title, string dataLabel, IReadOnlyList<string> labels, IReadOnlyList<string> yValues)
        {
            if (labels.Count != yValues.Count)
            {
                return;
