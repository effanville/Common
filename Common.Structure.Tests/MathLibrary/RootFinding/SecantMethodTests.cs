...
namespace Common.Structure.Tests.MathLibrary.RootFinding
{
    ...
    public sealed class SecantMethodTests
    {
        ...
        {
            var rootFindingResult = SecantMethod.FindRoot(testData.Func, testData.Lower, testData.Upper, testData.MaxIterations, testData.Tolerance);
        ...
        {
            var rootFindingResult = SecantMethod.FindRoot(testData.Func, testData.Lower, testData.Upper, maxIterations: 20);
