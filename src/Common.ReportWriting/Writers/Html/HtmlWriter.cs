...
namespace Effanville.Common.ReportWriting.Writers.Html
{
    internal sealed class HtmlWriter : ITextWriter
    {
        ...
        {
            fIncludeStyling = includeStyling;
            fIncludeScripts = includeScripts;
        }
        ...
        /// <inheritdoc/>
        public void WriteParagraph(StringBuilder sb, IReadOnlyList<string> sentence, DocumentElement tag = DocumentElement.p)
        {
