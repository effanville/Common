namespace Effanville.Common.ReportWriting.Documents
{
    ...
    public class DocumentPart : IEquatable<DocumentPart>
    {
        ...
        /// </summary>
        public string ConstituentString { get; }
        ...
        /// <inheritdoc/>
        public override string ToString() => ConstituentString;

        /// <inheritdoc/>
        public virtual bool Equals(DocumentPart other)
        {
            if (other == null)
            {
                return false;
        ...
        public override int GetHashCode()
            => HashCode.Combine(DocType.GetHashCode(), Element.GetHashCode(), ConstituentString.GetHashCode());
    }
}