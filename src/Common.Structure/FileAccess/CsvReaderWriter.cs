...
public static class CsvReaderWriter
{
    ...
    public static List<object> ReadFromCsv<T>(T dataGainer, string filePath, IReportLogger reportLogger = null)
        where T : ICSVAccess
        => ReadFromCsv(dataGainer, new FileSystem(), filePath, reportLogger);
    ...
    public static List<object> ReadFromCsv<T>(T dataGainer, IFileSystem fileSystem, string filePath, IReportLogger reportLogger = null) where T : ICSVAccess
    {
        ...
        {
            reportLogger?.Exception(nameof(CsvReaderWriter), ex);
    ...
    /// <param name="filePath">The path of file to read from.</param>
    /// <param name="reportLogger">Reporting Callback.</param>
    public static void WriteToCSVFile<T>(T dataTypeToWrite, string filePath, IReportLogger reportLogger = null)
        where T : ICSVAccess
